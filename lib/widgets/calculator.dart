...
class _CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context) {
    ...
    log(formatoBolivar.format(coinProvider.amount).toString(), name: 'amount provider Bs');
    log(formatoDolar.format(coinProvider.amount).toString(), name: 'amount provider USD');
                            ...
                            children: [
                              TextSpan(
                                text: coinProvider.isDestinationVES() ? 
                                  formatoBolivar.format(coinProvider.currentAmount) :
                                  ExchangeType.oficialUsd == coinProvider.exchangeType ? "${formatoDolar.format(coinProvider.currentAmount)} USD" :
                                  ExchangeType.oficialEur == coinProvider.exchangeType ? "${formatoEuro.format(coinProvider.currentAmount)} EUR" :
                                  ExchangeType.p2pUsdt == coinProvider.exchangeType ? "${formatoDolar.format(coinProvider.currentAmount)} USDT" :
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ...
                        toastification.show(
                          ...
                          title: Text( isVes ? formatoBolivar.format(coinProvider.currentAmount) : ExchangeType.oficialUsd == coinProvider.exchangeType ? "${formatoDolar.format(coinProvider.currentAmount)} USD" : ExchangeType.oficialEur == coinProvider.exchangeType ? "${formatoEuro.format(coinProvider.currentAmount)} EUR" : coinProvider.destinationCurrency == Currency.usd
                                  ? "${formatoDolar.format(coinProvider.currentAmount)} USD"
                                  : coinProvider.destinationCurrency == Currency.ves
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.grey),
